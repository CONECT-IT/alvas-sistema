...
<div class="flex flex-col gap-6">
	<div class="flex flex-col justify-between gap-4 md:flex-row md:items-end">
		<div>
			<p class="text-sm font-semibold tracking-[0.18em] text-primary uppercase">Reportes</p>
			<h1 class="mt-2 font-display text-3xl font-bold text-text-main">Resumen comercial</h1>
