...
>
	...
	<h1 class="font-display text-2xl font-bold text-text-main">Analítica y Reportes</h1>
	<p class="text-sm leading-relaxed text-text-muted">
		Reportes estadísticos de conversión de asesores, tiempos de respuesta a leads y volumen de
		ventas concretadas por trimestre.
	</p>
