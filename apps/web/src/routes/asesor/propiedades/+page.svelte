...
>
	...
	<h1 class="font-display text-2xl font-bold text-text-main">Propiedades en Cartera</h1>
	<p class="text-sm leading-relaxed text-text-muted">
		Fichas de propiedades que tienes asignadas para la comercialización directa y visitas guiadas de
		clientes.
	</p>
